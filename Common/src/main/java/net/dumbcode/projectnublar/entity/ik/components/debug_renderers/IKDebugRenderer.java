...
public interface IKDebugRenderer<E extends IKAnimatable<E>, C extends IKModelComponent<E>> {
    ...
    static void drawLineToBox(PoseStack matrices, MultiBufferSource vertexConsumers, Vec3 camera, Vec3 startPos, Vec3 targetPos, Dinosaur entity, int red, int green, int blue, int alpha) {
