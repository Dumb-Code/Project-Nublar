...
public class EntityLeg extends AngleConstraintIKChain {
    ...
    public void stretch(Vec3 target, Vec3 base) {
        Vec3 rotatedTarget = MathUtil.rotatePointOnAPlainAround(target, base, 90, MathUtil.getClosestNormalRelativeToEntity(target, base, base.add(MathUtil.getFlatRotationVector(this.entity)), this.entity));
