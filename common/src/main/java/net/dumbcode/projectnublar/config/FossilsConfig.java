...
public class FossilsConfig {
    ...
    public static Map<String,Double> getPeriods() {
        List<String> timePeriods = List.of("carboniferous", "jurassic", "cretaceous");
        Map<String,Double> periodMap = new HashMap<>();
        periodMap.put("carboniferous", INSTANCE.carboniferous.rarityModifier.get());
        periodMap.put("jurassic", INSTANCE.jurassic.rarityModifier.get());
        periodMap.put("cretaceous", INSTANCE.cretaceous.rarityModifier.get());
